...
parser.add_argument("refdir", type=str, help="files containing read hits per target")
parser.add_argument("bedfile", type=str, help="bed file for targets")
parser.add_argument(
    "outdir", type=str, help="files containing length normalized read hits per target"
)
